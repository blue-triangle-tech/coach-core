...
module.exports = {
  ...
  description:
    'Using third party requests shares user information with that third party. Please avoid that!',
  weight: 5,
  tags: ['privacy'],
  processPage: function (page) {
    ...
    if (
      ...
      score = 0;
      advice +=
        ' The page also have request to companies that harvest data from users and do not respect users privacy. ';
    }
