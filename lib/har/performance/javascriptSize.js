      ...
      advice:
        score < 100
          ? 'The total JavaScript transfer size is ' +
            ...
            '. ' +
            (contentSize > 1000000
              ? 'This is significantly larger than recommended. Review and optimize your JavaScript to improve performance.'
              : 'The JavaScript size is relatively large. Consider auditing dependencies and reducing unused code. ')
          : ''
    };
  }
};
